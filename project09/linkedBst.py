    ...
    def preorder(self):
        ...
        while not q.isEmpty():
            if myModCount != self.getModCount():
                raise AttributeError("Mutations not allowed in a traversal")
    ...
    def remove(self, item):
        ...
        def recurse(node):
            ...
            # Traverse right
                ...
                #check if left and right child if so call the already written function
